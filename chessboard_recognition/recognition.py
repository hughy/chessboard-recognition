...
from chessboard_recognition import board
from chessboard_recognition import piece_model
...
if __name__ == "__main__":
    ...
    parser.add_argument("filepath", type=str, help="Filepath for the input image.")
